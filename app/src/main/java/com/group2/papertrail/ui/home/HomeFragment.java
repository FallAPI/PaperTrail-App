...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        PaperRecylerViewAdapter recentlyAdapter = new PaperRecylerViewAdapter(recentlyItems, getContext());
        ...
        PaperRecylerViewAdapter favoriteAdapter = new PaperRecylerViewAdapter(favoritesItems, getContext());
